...
const dayIsChecked = (weekday) => {
    return category.value.available_days.includes(weekday)
}
...
<template>
    ...
    <div v-if="category" class="card bg-base-200 shadow-xl">
        <div class="card-body">
            ...
            <form @submit.prevent="onSubmitUpdateCategory" class="grid grid-cols-1 lg:grid-cols-2 gap-2">
                ...
                <label class="form-control w-full">
                    ...
                    <input :value="category.available_from.split('T')[0]" type="date" name="available_from"
                ...
                <label class="form-control w-full">
                    ...
                    <input :value="category.available_until.split('T')[0]" type="date" name="available_until"
                        class="input input-bordered w-full" />
                </label>
                <label class="form-control w-full">
                    <div class="label">
                    ...
                    <input :value="category.available_from_hour" type="time" name="available_from_hour"
                        class="input input-bordered w-full" />
                </label>
                <label class="form-control w-full">
                    <div class="label">
                    ...
                    <input :value="category.available_until_hour" type="time" name="available_until_hour"
                        class="input input-bordered w-full" />
                </label>
